      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 p-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            take up new tech stacks as needed. Being a great developer, in my
            opinion, is about selecting the greatest tool for the job rather
            than employing a specific language.
          </p>
          <p className="py-2 text-gray-600">
            In the year 2020, I began developing various models. I have two
            years of expertise to work professionally in the field. I enjoy
            competitive coding in my leisure time.
          </p>
          <Link href="/#projects">
